...
const ResumeFormatTips = ({ formattingTips }: ResumeFormatTipsProps) => {
  return (
    <section className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-lg border border-purple-200 shadow-sm">
        ...
        <div className="flex items-center gap-4 mb-2">
          <div>
            ...
            <span className="font-semibold text-gray-900">
              {formattingTips.pageCount.current} page(s)
            </span>
          </div>
          ...
          <div>
            ...
            <span className="font-semibold text-blue-600">
              {formattingTips.pageCount.recommended} page(s)
            </span>
          </div>
        </div>
        <p className="text-sm text-gray-700">{formattingTips.pageCount.reasoning}</p>
      </div>
      ...
      {formattingTips.industrySpecific.length > 0 && (
